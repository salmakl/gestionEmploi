...
<body>
    <div class="container-fluid bg">
        <div class="row">
            <div class="col-4"></div>
            <div class="col-md-4">
                <form class="form-container" method="POST" action="http://localhost/gestionEmploi/user/createAccount">
                    ...
                    <a href="http://localhost/gestionEmploi/login/"><input type="button" class="btn btn-success" name="Login" value="Login"></a>
                </form>
            </div>
            <div class="col-4"></div>
        </div>
