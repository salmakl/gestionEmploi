...
<html lang="en">
  ...
  <body>
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                  <li class="nav-item active">
                    <a class="nav-link "  href="http://localhost/gestionEmploi/reservation/">reservation</a>
                  </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                  <li class="nav-item">
                    <a  class="nav-link " href="http://localhost/gestionEmploi/logout/">logout</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div class="container mt-4">
      ...
      <a class="btn btn-primary float-end mb-4" id="open" href="http://localhost/gestionEmploi/user/addPage"><b>Ajouter Reservation</b></a>
